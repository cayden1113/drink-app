...
export default function MedicalReport({ data, isConnected, recommendations }: MedicalReportProps) {
  ...
  // 辅助函数：检查指标是否正常
  const isNormal = (value: number, range: { min?: number, max?: number }) => {
                      ...
                      <div>
                        ...
                        <div className="border rounded-lg p-4">
                          <div className="grid grid-cols-5 gap-2 mb-3">
                            {Object.entries(data.meridianBalance).map(([englishMeridian, value]) => {
                              const chineseMeridian = MERIDIAN_MAP[englishMeridian] || englishMeridian;
                              return (
                                <div key={englishMeridian} className="text-center">
                                  ...
                                  <div className="text-xs">{chineseMeridian}经</div> {/* 显示中文经络名 */}
                          ...
                          <div className="space-y-2 mt-4">
                            ...
                            {Object.entries(data.meridianBalance)
                              ...
                              .map(([englishMeridian]) => {
                                const chineseMeridian = MERIDIAN_MAP[englishMeridian] || englishMeridian;
                                return (
                                  <div key={englishMeridian} className="flex items-start">
                                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-1.5 mr-2"></div>
                                    <div>
                                      <p className="text-sm font-medium">{chineseMeridian}经不足</p>
                                      <p className="text-xs text-muted-foreground">
                                        {englishMeridian === "lung" ? "可能导致呼吸系统问题，易感冒" : 
                                         englishMeridian === "heart" ? "可能导致心悸、失眠、多梦" : 
                                         englishMeridian === "spleen" ? "可能导致消化不良、疲劳乏力" : 
                                         englishMeridian === "liver" ? "可能导致情绪波动、头痛目眩" : 
                                         "可能导致腰膝酸软、耳鸣健忘"}
                                      </p>
                                    </div>
                                  </div>
                        ...
                        <div className="border rounded-lg p-4">
                          <div className="space-y-3">
                            <div>
                              <div className="flex justify-between text-sm mb-1">
                                <span>心率</span>
                                <span className={!isNormal(data.heartRate, NORMAL_RANGES.heartRate) ? "text-red-500" : "text-green-500"}>
                              ...
                              <div className="w-full h-2 bg-gray-200 rounded-full">
                                <div
                                  className={`h-full rounded-full ${
                                    !isNormal(data.heartRate, NORMAL_RANGES.heartRate) ? "bg-red-500" : "bg-green-500"
                                  }`}
                            ...
                            <div>
                              <div className="flex justify-between text-sm mb-1">
                                <span>血压</span>
                                <span className={
                                  !isNormal(data.bloodPressure.systolic, NORMAL_RANGES.bloodPressure.systolic) || 
                                  !isNormal(data.bloodPressure.diastolic, NORMAL_RANGES.bloodPressure.diastolic)
                              ...
                              <div className="w-full h-2 bg-gray-200 rounded-full">
                                <div
                                  className={`h-full rounded-full ${
                                    !isNormal(data.bloodPressure.systolic, NORMAL_RANGES.bloodPressure.systolic) ? "bg-red-500" : "bg-green-500"
                                  }`}
                            ...
                            <div>
                              <div className="flex justify-between text-sm mb-1">
                                <span>血糖</span>
                                <span className={!isNormal(data.bloodGlucose, NORMAL_RANGES.bloodGlucose) ? "text-red-500" : "text-green-500"}>
                              ...
                              <div className="w-full h-2 bg-gray-200 rounded-full">
                                <div
                                  className={`h-full rounded-full ${
                                    !isNormal(data.bloodGlucose, NORMAL_RANGES.bloodGlucose) ? "bg-red-500" : data.bloodGlucose > 5.6 ? "bg-amber-500" : "bg-green-500"
                                  }`}
                            ...
                            <div>
                              <div className="flex justify-between text-sm mb-1">
                                <span>炎症指数</span>
                                <span className={!isNormal(data.inflammation, NORMAL_RANGES.inflammation) ? "text-red-500" : "text-green-500"}>
                            ...
                            {Object.entries(data.electrolytes).map(([electrolyte, value]) => (
                              <div key={electrolyte} className="text-center">
                                ...
                                <div className="w-full h-2 bg-gray-200 rounded-full mt-1">
                                  <div
                                    className={`h-full rounded-full ${
                                      !isNormal(value, NORMAL_RANGES[electrolyte]) ? "bg-amber-500" : "bg-green-500"
                                    }`}
                                    style={{ 
                                ...
                                <div className="text-xs text-muted-foreground mt-1">
                                  {isNormal(value, NORMAL_RANGES[electrolyte]) ? "正常" : 
                                   value < (NORMAL_RANGES[electrolyte]?.min || Infinity) ? "偏低" : "偏高"}
                                </div>
                              </div>
                            ))}
                          </div>
